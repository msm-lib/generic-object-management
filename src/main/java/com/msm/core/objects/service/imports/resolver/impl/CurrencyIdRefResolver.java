...
public class CurrencyIdRefResolver extends AbstractObjectAttributeRefResolver {

    public CurrencyIdRefResolver(ObjectQueryRepository internalObjectQueryRepository, GenericObjectInternalService genericObjectInternalService) {

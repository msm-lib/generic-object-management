...
import com.msm.core.objects.dataexchange.imports.s3.S3MultipartOutputStream0;
...
public class ExportExcelService {
    ...
    public void exportExcelData(String schemaFolder, Map<String, Object> exportJobMap) {
        ...
        Map<Integer, ColumnHeaderPath> attributeColumnMapping = exportExcelTemplateService.extractColumnHeaderMap(
                templateBytes,
                exportJobRecord.get(ExportJobMeta.ID),
                objectName
        );
        ...
        try (
            ...
            request.getPageRequest().setSize(batchSize);

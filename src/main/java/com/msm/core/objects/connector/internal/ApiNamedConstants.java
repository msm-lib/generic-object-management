...
public class ApiNamedConstants {
    ...
    public static final String PATH_BY_OBJECT = "/api/v1/internal/generic/objects/{0}";
    ...
    public static final String PATH_ACTION = "/api/v1/internal/generic/objects/{0}/{1}/{2}";

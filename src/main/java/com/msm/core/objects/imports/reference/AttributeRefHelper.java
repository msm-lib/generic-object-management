...
public class AttributeRefHelper {
    ...
    public static void retainAllRefData(Attribute attribute, List<Map<String, Object>> objectList) {
        Set<String> refNames = new HashSet<>(getOrDefaultReturnFields(attribute.getAttributeRef()));

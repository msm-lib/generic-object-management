...
public class ImportJobService {
    ...
    public Map<String, Object> importJob(ActionContext<Map<String, Object>> actionContext) {
        ...
        DataRecord dataRecord = DataRecord.of()
        ...
        DataRecord dataJobImport = DataRecord.of(internalObjectQueryRepository.save(ImportJobMeta.OBJECT_NAME, dataRecord.getValues()));
